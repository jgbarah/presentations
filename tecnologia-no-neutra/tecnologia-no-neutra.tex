...
\title{¿Así que tú crees que la tecnología es neutra?}
%\subtitle{}
\author{Jesús M. González Barahona}
\institute{jgb@gsyc.es ~~~~ \url{http://twitter.com/jgbarah} \\
  GSyC/LibreSoft, Universidad Rey Juan Carlos \\ }

\date{T3chfest 2018, Universidad Carlos III \\
  Leganés, 1 de marzo de 2018\\
\url{https://speakerdeck.com/jgbarah/} \\}
...
\begin{frame}
\frametitle{Y muchos otros casos...}
...
\begin{frame}
\frametitle{Tendencias: el código y la ley}

\begin{center}
Históricamente, los sistemas legales han impuesto sus limitaciones. \\
Ahora, los sistemas tecnológicos también lo hacen. \\
Y muy frecuentemente se refuerzan entre ambos. \\
\end{center}
...
\begin{frame}
\frametitle{Tendencias: la guerra sobre el ordenador generalista}
...
\end{flushright}
  {\tiny
\url{http://boingboing.net/2011/12/27/the-coming-war-on-general-purp.html}
}
