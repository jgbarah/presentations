...
\title[Generative AI]{Generative Artificial Intelligence with ``Open'' Models}
%\subtitle{}
...
\date[October 2023]{\small Jornadas Anuales Wikimedia España \\
  Salamanca, Spain, Nov 11th 2023~~~~~~~~\includegraphics[width=1.2cm]{figs/by-sa}}
...
\begin{frame}[fragile]
  ...
  \includegraphics[width=6.5cm]{figs/sd-free-culture-enthusiast-dino}
...
%% -----------------------------------------
\begin{frame}[fragile]
\frametitle{Help training a model}
