...
{
  {
    \usebackgroundtemplate{\hbox to \paperwidth{\hfil{\includegraphics[width=\linewidth,height=\paperheight]{\secimage}}}}
    \begin{frame}<beamer>
...
\institute{Correo: jesus.gonzalez.barahona@urjc.es ~~ @jgbarah@floss.social \\
...
\begin{flushright}
{\small
\copyright 2012-2022 Jesús M. González Barahona. \\
