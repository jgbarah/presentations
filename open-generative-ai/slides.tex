...
\title[Open Generative AI]{Open Models for Generative Artificial Intelligence}
%\subtitle{}
...
\date[June 2025]{\small I Jornadas de Software Libre en Educacion \\
  IES Rafael Alberti, Cadiz, Spain, June 2 2025~~\includegraphics[width=1.2cm]{figs/by-sa}}
...
%%-----------------------------------------
\begin{frame}[fragile]
  \includegraphics[width=9cm]{figs/ies_rafael_alberti}

\end{frame}

%%-----------------------------------------
\begin{frame}[fragile]
  \includegraphics[width=9cm]{figs/cats_ies_rafael_alberti}

\end{frame}

%%-----------------------------------------
\begin{frame}[fragile]
  \includegraphics[width=9cm]{figs/dinosaurs_ies_rafael_alberti}
...
\begin{frame}[fragile]
  ...
  \begin{center}
    {\large
      \url{https://api.aime.info/tts-tortoise/}
    }
  \end{center}
\end{frame}
...
%% -----------------------------------------
\begin{frame}[fragile]
  \frametitle{Example: Stable Diffusion 1.0}
...
%%-----------------------------------------
\begin{frame}[fragile]
\frametitle{``Open reproducible model''}

All of the above, and

\begin{center}
  {\Large complete training set}
\end{center}

(and any other detail needed to produce the same binary model)
\end{frame}

%%-----------------------------------------
\begin{frame}[fragile]
\frametitle{The four freedoms}

\begin{itemize}
\item Freedom to use
\item Freedom to study and modify
\item Freedom to distribute
\item Freedom to distribute modifications
\end{itemize}
...
\begin{itemize}
\item Model weights
\item Minimum: Detailed descritpion of the model architecture
\item Practical: Inference software
\item Permission
\end{itemize}
\end{frame}
...
%%-----------------------------------------
\begin{frame}[fragile]
\frametitle{Study and modify}

\begin{itemize}
\item Training set, software \& parameters
\item Permission
\end{itemize}

Special case: Finetuning \\
...
%%-----------------------------------------
\begin{frame}[fragile]
\frametitle{Open Source AI}

Open Source AI Definition:

\begin{itemize}
\item Fundamentally, four freedoms
\item ...but...
\item ...only description of the training set
\end{itemize}
...
%%-----------------------------------------
\begin{frame}[fragile]
\frametitle{Example: computer-agent}
...
\begin{itemize}
\item Agents framework: smolagents
\item Model: Qwen2-VL-72B
\item Desktop: E2B Desktop
\end{itemize}
...
%%-----------------------------------------
\begin{frame}[fragile]
\frametitle{Models to download}

\begin{itemize}
\item HuggingFace: all kinds \\
...
%%-----------------------------------------
\begin{frame}[fragile]
\frametitle{Models via cloud APIs}

\begin{itemize}
\item OpenRouter: text \\
  \url{https://openrouter.ai/}
\item Groq: text \\
  \url{https://groq.com/}
\item Replicate: images \\
  \url{https://replicate.com}
\item Together.ai: multimodal \\
  \url{https://together.ai/}
\item SambaNova: multimodal \\
...
%%-----------------------------------------
\begin{frame}[fragile]
  \frametitle{Text to speech: Tortoise TTS}
...
Llama4, Llama Community License
\begin{flushright}
