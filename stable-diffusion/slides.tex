...
\title[Stable Diffusion]{Simple Introduction to Stable Difussion}
%\subtitle{}
...
%%-----------------------------------------
%%-----------------------------------------
\section{Stable Diffussion release}


%%-----------------------------------------
\begin{frame}[fragile]
  \frametitle{Stable Diffusion first release}
...
%%-----------------------------------------
\begin{frame}[fragile]
  \frametitle{Integration in toolchains}
...
%%-----------------------------------------
\begin{frame}[fragile]
  \frametitle{Whisper fro Toutube captions}
...
\begin{frame}[fragile]
  ...
  Blazingly Fast 44.1 kHz Stereo Waveform Music Generation of Arbitrary Length
...
%%-----------------------------------------
\begin{frame}[fragile]
  \frametitle{Intelectual property (training set)}
...
%%-----------------------------------------
\begin{frame}[fragile]
  \frametitle{Intelectual property (results)}
